...
(function (ag) {
    (function (components) {
        var Explorer = (function () {
            function Explorer(options) {
                ...
                if (options.modal) {
                    ...
                    if (this.viewContainer.length > 0) {
                        this.viewContainer = this.viewContainer.clone().appendTo($(options.container || 'body')).show();
                    }
                }
                ...
                $(".items .grid", _viewContainer).on("click", "th", function () {
                    // Sort on this column
                ...
                if (_viewContainer.hasClass('modal')) {
                    _viewContainer.off('show').off('shown').off('hidden').on('show', function () {
            ...
            Explorer.prototype.toggle = function (toggleOpts) {
