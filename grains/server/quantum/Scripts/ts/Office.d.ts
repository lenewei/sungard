...
declare module Microsoft.Office.WebExtension {
    ...
    export class Binding {
        ...
        setDataAsync(data, options?: { coercionType?: CoercionType; startRow?: number; startColumn?: number; asyncContext?: any; }, callback?: (result: AsyncResult) => void): void;
...
declare module Microsoft.Office.WebExtension {
    ...
    export class Document {
        ...
        goToByIdAsync: (id: any, goToType: Microsoft.Office.WebExtension.GoToType, options?: { asyncContext?: any; }, callback?: (result: AsyncResult) => void) => void ;
    }
}
declare module Microsoft.Office.WebExtension {
...
declare module Microsoft.Office.WebExtension {
    ...
    //export class Office {
      ...
      export  var  context: Microsoft.Office.WebExtension.Context;
       ...
       export function select(str: string, onError: () => void);
        ...
        export var initialize: (reason?: Microsoft.Office.WebExtension.InitializationReason) => void;
...
declare module Microsoft.Office.WebExtension {
    ...
    export class Settings {
        ...
        removeHandlerAsync(eventType: Microsoft.Office.WebExtension.EventType, handler: any, options?: { handler?: string; asyncContext?: any; }, callback?: (result: AsyncResult) => void): void;
